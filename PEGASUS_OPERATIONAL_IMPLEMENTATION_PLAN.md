...
| `she/` | 32 | 5,390 | substrate, population tensor, ST-DFM, sidra context | **KEEP + EXTEND**: substrate stays; `population/` → `denominators/`; `stdfm/` → LDO low-rank layer |
| `datasus/` | 16 | 4,187 | decoders, normalizers, ICD, fetch | **KEEP decoders; CONSOLIDATE 4 normalizers → declarative; MOVE** under `sources/datasus/` |
...
| `compute/` | 7 | 1,467 | `glm.py` (1,150), devices, memory | **KEEP; ADD `randnla.py`, `controller.py`** |
