...
def patch_cli() -> None:
    ...
    if "from pegasus.datasus.normalize import normalize_sim_do_events" not in text:
        text = text.replace(
...
'''
    ...
    if 'datasus_normalize_sim(' not in text:
        if marker not in text:
            raise RuntimeError("Could not find CLI insertion marker before sidra metadata command.")
...
def main() -> None:
    write("src/pegasus/datasus/normalize.py", r'''
    from __future__ import annotations
    ...
    write("tests/fixtures/datasus/sim_do_fixture.csv", r'''
    DTOBITO,HORAOBITO,DTNASC,IDADE,SEXO,RACACOR,CODMUNRES,CODMUNOCOR,LOCOCOR,CODESTAB,CAUSABAS,LINHAA,LINHAB,LINHAC,LINHAD,LINHAII,TIPOBITO,IDADEMAE,ESCMAE,ESCMAE2010,OCUPMAE,QTDFILVIVO,QTDFILMORT,GRAVIDEZ,SEMAGESTAC,GESTACAO,PARTO,OBITOPARTO,PESO,OBITOGRAV,OBITOPUERP,ASSISTMED,EXAME,CIRURGIA,NECROPSIA,COMUNSVOIM,DTATESTADO,TPPOS,DTINVESTIG,CAUSABAS_O
    01012022,1230,01011948,474,1,4,270430,270430,1,0001234,A419,*J189,I10,,,,2,,,,,03,00,,,,,,9999,,,1,1,2,2,,02012022,1,03012022,A419
    02022022,0815,,402,2,9,270430,270430,3,,R99,,,,,,2,,,,,99,00,,,,,,0000,,,2,2,2,1,,03022022,,,
    15032022,2500,14032022,201,1,1,270030,270030,1,0000000,P369,*P369,,,,Q249,2,22,3,3,999999,01,00,1,39,5,1,1,2800,3,3,1,1,2,2,270430,16032022,1,17032022,
    ''')
    ...
    print("Applied Slice 1C: SIM-DO fixture normalization contract, fixture, tests, and CLI normalize-sim command.")
