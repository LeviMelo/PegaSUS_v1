...
def main() -> None:
    write("src/pegasus/datasus/icd_groups.py", r'''
    from __future__ import annotations
    ...
    write("tests/unit/test_icd_groups.py", r'''
    ...
    write("tests/unit/test_sim_fixture_icd_expansion.py", r'''
    from pathlib import Path
    ...
    print("Applied Slice 1E: ICD chapter/block mortality expansion, crude mortality fixture node, and topology observer fields.")
