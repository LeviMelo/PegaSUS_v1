...
_SIM_CATEGORICAL: dict[str, tuple[str, str]] = {
    ...
    "medical_assistance": ("ASSISTMED", "yes_no_strict"),
    "exam_performed": ("EXAME", "yes_no_strict"),
    "surgery_performed": ("CIRURGIA", "yes_no_strict"),
    "autopsy_performed": ("NECROPSIA", "yes_no_strict"),
    "investigation_status": ("TPPOS", "investigation_status"),
    "death_circumstance": ("CIRCOBITO", "death_circumstance"),
}
...
def _sim_vectorized_frame(df: pl.DataFrame, *, source_manifest_hash: str) -> pl.DataFrame:
    ...
    out = df.with_row_index("_i").with_columns(
        ...
        cat("yes_no_strict", "ASSISTMED").alias("medical_assistance"),
        cat("yes_no_strict", "EXAME").alias("exam_performed"),
        cat("yes_no_strict", "CIRURGIA").alias("surgery_performed"),
        cat("yes_no_strict", "NECROPSIA").alias("autopsy_performed"),
        ...
        cat("death_circumstance", "CIRCOBITO").alias("death_circumstance"),
