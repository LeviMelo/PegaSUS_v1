...
build_hsic_output_bundle = _retired
write_hsic_bundle = _retired
attach_hsic_to_run = _retired

__all__ = ['build_hsic_output_bundle', 'write_hsic_bundle', 'attach_hsic_to_run', 'RetiredLegacyBundleError']
