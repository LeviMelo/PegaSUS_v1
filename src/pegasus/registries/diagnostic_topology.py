"""
Slice 0 scaffold module: registries/diagnostic_topology.py
...
def blocked(*, module: str = "registries/diagnostic_topology.py", reason: str = "slice0_scaffold_only") -> None:
