...
def run_attach_cnes_sih_compile_fields(*args, **kwargs):
    raise RuntimeError(
        "CNES/SIH manual compile attach is retired. "
        "CNES/SIH fields must be produced by SHE substrate + autonomous EFG bridge/operator expansion."
    )
