...
def compile_run(intent_path: str | Path, root: str | Path = ".") -> Path:
    """Create the first architecture-valid empty run bundle.

    This is not yet the epidemiological compiler. It is the run-bundle scaffold
    that later modules will populate.
    """
    ...
    bundle.write_reproducibility_manifest(run_id)
